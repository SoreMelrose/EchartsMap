<template>
    <div>
        ...
        <div>
            ...
            </el-table><el-button type="primary" @click="adduser()" align="center">添加用户</el-button>
            <template>
            </template>
        </div>
        <el-dialog
    ...
    export default {
        data: function(){
            ...
            var checkuser = (rule, value, callback) => {
                this.$http.post("/api/admin/listuser").then(
                    success=>{
        ...
        methods:{
            ...
            submit(form){
                this.$refs[form].validate((valid)=>
                {
                    if(valid){
                        ...
                        this.$http.post("/api/admin/updatepassword", params,{emulateJSON:true}).then(
                            success=> {
                                this.$message({
                                    type: 'success',
                                    message: '修改成功'
            ...
            ban(row){
                if(row.level=='管理员'){
                    ...
                    this.$http.post("/api/admin/banuser",params,{emulateJSON:true}).then(
                        success=>{
                            this.$message({
                                type:'success',
                                message:'切换成功'
            ...
            del(row){
                ...
                this.$http.post("/api/admin/deleteuser",params,{emulateJSON:true}).then(
                    success=>{
                        this.$message({
                            type:'success',
                            message:'删除成功'
            ...
            find(row){
                ...
                this.$http.post("/api/prjlisting/myprj", params,{emulateJSON:true}).then(
                    success=>{
            ...
            submit1(form1){
                ...
                this.$http.post("/api/admin/adduser",params).then(
                    success=>{
                        this.$message({
                            type:'success',
                            message:'添加成功'
            ...
            submit2(form){
                ...
                this.$http.post("/api/admin/updatemobile", params,{emulateJSON:true}).then(
                    success=> {
                        this.$message({
                            type: 'success',
                            message: '修改成功'
